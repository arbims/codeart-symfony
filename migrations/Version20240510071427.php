 ...
 */
final class Version20240510071427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, type INT NOT NULL, updated_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', created_at DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_5A8A6C8D12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE post_technology ADD CONSTRAINT FK_D71B5B8C4B89032C FOREIGN KEY (post_id) REFERENCES post (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE technology_technology ADD CONSTRAINT FK_29DA077915B5A9D8 FOREIGN KEY (technology_source) REFERENCES technologies (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE technology_technology ADD CONSTRAINT FK_29DA0779C50F957 FOREIGN KEY (technology_target) REFERENCES technologies (id) ON DELETE CASCADE');
    }
